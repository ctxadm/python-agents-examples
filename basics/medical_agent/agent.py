# ========================================
# MEDICAL AGENT (basics/medical_agent/agent.py) - FIXED für LiveKit 1.2.x
# ========================================
import os
import logging
import httpx
...
class MedicalAgent(Agent):
    """Medical Agent with RAG integration - using correct LiveKit 1.2.x pattern"""
    ...
    def __init__(self):
        ...
        logger.info("Medical assistant initialized with RAG support")
...
async def entrypoint(ctx: JobContext):
    """Main entry point for the agent - following the correct pattern"""
    logger.info("Starting medical agent entrypoint")
    
    # Create and start the agent session - KORREKTE API!
