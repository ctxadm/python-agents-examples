# ========================================
# GARAGE AGENT (basics/garage_agent/agent.py) - FIXED für LiveKit 1.2.x
# ========================================
import os
import logging
import httpx
...
class GarageAgent(Agent):
    """Garage Agent with RAG integration - using correct LiveKit 1.2.x pattern"""
    ...
    def __init__(self):
        ...
        logger.info("Garage assistant initialized with RAG support")
